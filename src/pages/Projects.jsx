...
const Projects = () => {
  ...
  const handleOpenEditModal = (project) => {
    ...
    setEditFormData({
      product_service: project.product_service || project.name || "",
      main_features: project.main_features || "",
      company_name: project.company_name || "",
      target_audience: project.target_audience || "",
      segment: project.segment || "",
      problems_solved: project.problems_solved || "",
      value_propositions:
        project.value_propositions || project.description || "",
      competitive_advantages: project.competitive_advantages || "",
      expected_objections: project.expected_objections || "",
      response_strategies: project.response_strategies || "",
    });
  ...
  const handleEditProject = async () => {
    if (!editFormData.product_service.trim()) {
    ...
    try {
      ...
      if (data && data[0]) {
        ...
        setProjects((prev) =>
          prev.map((project) =>
            project.id === editingProject.id
              ? {
                  ...project,
                  name: updatedProject.product_service,
                  description: updatedProject.value_propositions,
                  ...updatedProject,
                }
              : project
          )
        ...
        // Tenta atualizar no SQLite local também
        try {
          executeQuery(
            `UPDATE projects SET name = ?, description = ? WHERE id = ?`,
            [
              updatedProject.product_service,
              updatedProject.value_propositions,
              editingProject.id,
            ]
          );
          console.log("Projeto atualizado no banco local");
        } catch (sqlError) {
          console.warn("Não foi possível atualizar no banco local:", sqlError);
        }
      }
      ...
      alert("Erro ao editar projeto. Verifique o console para mais detalhes.");
    }
  };
            ...
            <div className="p-6">
              ...
              <div className="space-y-4 max-h-96 overflow-y-auto pr-2">
                <div>
                  ...
                  <Input
                    value={editFormData.product_service}
                    onChange={(e) =>
                      setEditFormData({
                        ...editFormData,
                        product_service: e.target.value,
                ...
                <div>
                  ...
                  <textarea
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    rows={2}
                    value={editFormData.main_features}
                    onChange={(e) =>
                      setEditFormData({
                        ...editFormData,
                        main_features: e.target.value,
                ...
                <div>
                  ...
                  <textarea
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    rows={2}
                    value={editFormData.problems_solved}
                    onChange={(e) =>
                      setEditFormData({
                        ...editFormData,
                        problems_solved: e.target.value,
                ...
                <div>
                  ...
                  <textarea
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    rows={2}
                    value={editFormData.value_propositions}
                    onChange={(e) =>
                      setEditFormData({
                        ...editFormData,
                        value_propositions: e.target.value,
                ...
                <div>
                  ...
                  <textarea
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    rows={2}
                    value={editFormData.competitive_advantages}
                    onChange={(e) =>
                      setEditFormData({
                        ...editFormData,
                        competitive_advantages: e.target.value,
                ...
                <div>
                  ...
                  <textarea
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    rows={2}
                    value={editFormData.expected_objections}
                    onChange={(e) =>
                      setEditFormData({
                        ...editFormData,
                        expected_objections: e.target.value,
                ...
                <div>
                  ...
                  <textarea
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    rows={2}
                    value={editFormData.response_strategies}
                    onChange={(e) =>
                      setEditFormData({
                        ...editFormData,
                        response_strategies: e.target.value,
